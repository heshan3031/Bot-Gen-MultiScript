...
echo "$Key" > $IVAR2
rm $HOME/lista-arq
wget --no-check-certificate -O /etc/SCRIPT/gerar.sh -q https://raw.githubusercontent.com/heshan3031/Bot-Gen-MultiScript/main/ChumoGH/Files-BOT.Open/SCRIPT/gerar.sh && chmod +x /etc/SCRIPT/gerar.sh
